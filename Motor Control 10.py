...
system_template_directions_output = "Return the directions from Start room to Goal room using A* search using the graph and heuristics provided. Only produce the final result."
