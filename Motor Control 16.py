...
def motion_control(route, distances):
    ...
    for item in route:
        ...
        if item == "forward":
            ...
            thread1 = threading.Thread(target=GPIO_Communication.motor_forward(distances[counter]))
            thread2 = threading.Thread(target=GPIO_Communication.motor_left(distances[counter]))
            ...
            thread1 = threading.Thread(target=GPIO_Communication.motor_forward(distances[counter]))
            thread2 = threading.Thread(target=GPIO_Communication.motor_right(distances[counter]))
            ...
            thread1 = threading.Thread(target=GPIO_Communication.motor_backward(distances[counter]))
            thread2 = threading.Thread(target=GPIO_Communication.motor_right(distances[counter]))
